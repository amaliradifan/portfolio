	...
	return (
		<>
			...
			>
				...
				<p>
					I am an{" "}
					<span className="text-light-secondBrand">Information Systems</span>{" "}
					...
					<span className="text-light-secondBrand">web development</span>,
				...
				<p>
					...
					<span className="text-light-secondBrand">web development</span> with
					frameworks like <span className="text-light-thirdBrand">Next.js</span>
					,<span className="text-light-thirdBrand">laravel</span> and{" "}
					<span className="text-light-thirdBrand">express</span>. To support
					backend development, I also study databases such as{" "}
					<span className="text-light-thirdBrand">MySQL</span>,{" "}
					<span className="text-light-thirdBrand">PostgreSQL</span>, and{" "}
					<span className="text-light-thirdBrand">MongoDB</span>. My focus is on
